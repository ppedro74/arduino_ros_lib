#ifndef _ROS_SERVICE_SetPIDConfig_h
#define _ROS_SERVICE_SetPIDConfig_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETPIDCONFIG[] = "abot_msgs/SetPIDConfig";

  class SetPIDConfigRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return SETPIDCONFIG; };
    virtual const char * getMD5() override { return "38f23c6006ec5f61168cd5ec71ba999f"; };

  };

  class SetPIDConfigResponse : public ros::Msg
  {
    public:
      typedef int32_t _result_type;
      _result_type result;

    SetPIDConfigResponse():
      result(0)
    {
    }
  ...
  class SetPIDConfig {
    public:
    typedef SetPIDConfigRequest Request;
    typedef SetPIDConfigResponse Response;
  };
